...
exports.userpost = async(req,res)=>{
    ...
    if (!fname || !email || !mobile || !gender || !location || !status || !file) {
...
exports.useredit = async(req,res)=>{
    ...
    const dateUpdates = moment(new Date()).format('YYYY-MM-DD hh:mm:ss');

    try {
        const updateuser = await users.findByIdAndUpdate({_id:id},{
            fname,lname,email,mobile,gender,location,status,profile:file,dateUpdates
        },{
            new:true,
        })
